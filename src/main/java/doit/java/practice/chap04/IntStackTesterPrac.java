...
import doit.java.practice.chap04.IntStackPrac;

import java.util.Scanner;

class IntStackTesterPrac {
    public static void main(String[] args) {
        Scanner stdIn = new Scanner(System.in);
        IntStackPrac s = new IntStackPrac(64);
        ...
        while (true) {
            ...
            switch (menu) {
                case 1:
                    ...
                    try {
                        s.push(x);
                    } catch (IntStackPrac.OverflowIntStackException e) {
                ...
                case 2:
                    ...
                    } catch (IntStackPrac.EmptyIntStackException e) {
